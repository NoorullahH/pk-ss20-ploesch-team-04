...
public class WeekChartBuilderForMulContrubutors extends Application {
	...
	public WeekChartBuilderForMulContrubutors(FilteredList<Task> filteredData, String toogleGroupValue, String startDate, String endDate) {
